...
4. you can "npm start" to build web in your local and "npm run deploy" to deploy your resume on the github which url is the homepage value setting in package.json
